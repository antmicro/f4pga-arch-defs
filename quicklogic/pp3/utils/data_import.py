...
from f4pga.utils.quicklogic.connections import build_connections, check_connections
from f4pga.utils.quicklogic.connections import hop_to_str, get_name_and_hop, is_regular_hop_wire
