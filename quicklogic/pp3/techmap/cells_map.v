...
// ============================================================================
// The "qlal4s3b_cell_macro" macro (EOS-S3)
...
// ============================================================================
// The "qlal3_left_assp_macro" macro (PP3e)
...
module qlal3_left_assp_macro (
  ...
  ASSPL _TECHMAP_REPLACE_ (
    .A2F_ACK                 (A2F_ACK),
    .A2F_ADDR                (A2F_ADDR),
    .A2F_Control             (A2F_Control),
    .A2F_GP_IN               (A2F_GP_IN),
    .A2F_GP_OUT              (A2F_GP_OUT),
    .A2F_RD_DATA             (A2F_RD_DATA),
    .A2F_REQ                 (A2F_REQ),
    .A2F_RWn                 (A2F_RWn),
    .A2F_Status              (A2F_Status),
    .A2F_WR_DATA             (A2F_WR_DATA),
    .Amult0                  (Amult0),
    .Bmult0                  (Bmult0),
    .Cmult0                  (Cmult0),
    .RAM0_ADDR               (RAM0_ADDR),
    ...
    .RAM0_RME_af             (RAM0_RME_af),
    .RAM0_RM_af              (RAM0_RM_af),
    .RAM0_TEST1_af           (RAM0_TEST1_af),
    .RAM0_WR_BE              (RAM0_WR_BE),
    .RAM0_WR_DATA            (RAM0_WR_DATA),
    .RAM0_WR_EN              (RAM0_WR_EN),
    .RAM8K_P0_ADDR           (RAM8K_P0_ADDR),
    .RAM8K_P0_CLK            (RAM8K_P0_CLK),
    .RAM8K_P0_WR_BE          (RAM8K_P0_WR_BE),
    .RAM8K_P0_WR_DATA        (RAM8K_P0_WR_DATA),
    .RAM8K_P0_WR_EN          (RAM8K_P0_WR_EN),
    .RAM8K_P1_ADDR           (RAM8K_P1_ADDR),
    .RAM8K_P1_CLK            (RAM8K_P1_CLK),
    .RAM8K_P1_RD_DATA        (RAM8K_P1_RD_DATA),
    .RAM8K_P1_RD_EN          (RAM8K_P1_RD_EN),
    .RAM8K_P1_mux            (RAM8K_P1_mux),
    .RAM8K_RME_af            (RAM8K_RME_af),
    .RAM8K_RM_af             (RAM8K_RM_af),
    .RAM8K_TEST1_af          (RAM8K_TEST1_af),
    .RAM8K_fifo_almost_empty (RAM8K_fifo_almost_empty),
    .RAM8K_fifo_almost_full  (RAM8K_fifo_almost_full),
    .RAM8K_fifo_empty_flag   (RAM8K_fifo_empty_flag),
    .RAM8K_fifo_en           (RAM8K_fifo_en),
    .RAM8K_fifo_full_flag    (RAM8K_fifo_full_flag),
    .RESET_n                 (RESET_n),
    .SEL_18_bottom           (SEL_18_bottom),
    .SEL_18_left             (SEL_18_left),
    .SEL_18_right            (SEL_18_right),
    .SEL_18_top              (SEL_18_top),
    .SPI_CLK                 (SPI_CLK),
    .SPI_MISO                (SPI_MISO),
    .SPI_MISOe               (SPI_MISOe),
    .SPI_MOSI                (SPI_MOSI),
    ...
    .SYSCLK                  (SYSCLK),
    .SYSCLK_x2               (SYSCLK_x2),
    .Valid_mult0             (Valid_mult0),
    .af_burnin_mode          (af_burnin_mode),
    .af_dev_id               (af_dev_id),
    .af_fpga_int_en          (af_fpga_int_en),
    .af_opt_0                (af_opt_0),
    .af_opt_1                (af_opt_1),

//    .\af_plat_id[0]          (\af_plat_id[0] ),
//    .\af_plat_id[1]          (\af_plat_id[1] ),
//    .\af_plat_id[2]          (\af_plat_id[2] ),
//    .\af_plat_id[3]          (\af_plat_id[3] ),
//    .\af_plat_id[4]          (\af_plat_id[4] ),
//    .\af_plat_id[5]          (\af_plat_id[5] ),
//    .\af_plat_id[6]          (\af_plat_id[6] ),
//    .\af_plat_id[7]          (\af_plat_id[7] ),

    .af_plat_id              ({ \af_plat_id[7] , \af_plat_id[6] ,
                                \af_plat_id[5] , \af_plat_id[4] ,
                                \af_plat_id[3] , \af_plat_id[2] ,
                                \af_plat_id[1] , \af_plat_id[0] }),

    .af_spi_cpha             (af_spi_cpha),
    .af_spi_cpol             (af_spi_cpol),
    .af_spi_lsbf             (af_spi_lsbf),
    .default_SPI_IO_mux      (default_SPI_IO_mux),
    .drive_io_en_0           (drive_io_en_0),
    .drive_io_en_1           (drive_io_en_1),
    .drive_io_en_2           (drive_io_en_2),
    .drive_io_en_3           (drive_io_en_3),
    .drive_io_en_4           (drive_io_en_4),
    .drive_io_en_5           (drive_io_en_5),
    .fast_clk_out            (fast_clk_out),
    .int_i                   (int_i),
    .int_o                   (int_o),
    .osc_en                  (osc_en),
    .osc_fsel                (osc_fsel),
    ...
    .reg_clk_int             (reg_clk_int),
    .reg_rd_data_int         (reg_rd_data_int),
    .reg_rd_en_int           (reg_rd_en_int),
    .reg_wr_data_int         (reg_wr_data_int),
    .reg_wr_en_int           (reg_wr_en_int)
  );
endmodule

// ============================================================================
// The "qlal3_right_assp_macro" macro (PP3e)
...
module qlal3_right_assp_macro (
  ...
  ASSPR _TECHMAP_REPLACE_ (
    ...
    .RAM1_RME_af      (RAM1_RME_af),
    .RAM1_RM_af       (RAM1_RM_af),
    .RAM1_TEST1_af    (RAM1_TEST1_af),
    .RAM1_WR_BE       (RAM1_WR_BE),
    .RAM1_WR_DATA     (RAM1_WR_DATA),
    .RAM1_WR_EN       (RAM1_WR_EN),
    .RAM2_P0_ADDR     (RAM2_P0_ADDR),
    .RAM2_P0_CLK      (RAM2_P0_CLK),
    .RAM2_P0_WR_BE    (RAM2_P0_WR_BE),
    .RAM2_P0_WR_DATA  (RAM2_P0_WR_DATA),
    .RAM2_P0_WR_EN    (RAM2_P0_WR_EN),
    .RAM2_P1_ADDR     (RAM2_P1_ADDR),
    .RAM2_P1_CLK      (RAM2_P1_CLK),
    .RAM2_P1_RD_DATA  (RAM2_P1_RD_DATA),
    .RAM2_P1_RD_EN    (RAM2_P1_RD_EN),
    .RAM2_RME_af      (RAM2_RME_af),
    .RAM2_RM_af       (RAM2_RM_af),
    .RAM2_TEST1_af    (RAM2_TEST1_af),
    .RAM3_P0_ADDR     (RAM3_P0_ADDR),
    .RAM3_P0_CLK      (RAM3_P0_CLK),
    .RAM3_P0_WR_DATA  (RAM3_P0_WR_DATA),
    .RAM3_P0_WR_EN    (RAM3_P0_WR_EN),
    .RAM3_P1_ADDR     (RAM3_P1_ADDR),
    .RAM3_P1_CLK      (RAM3_P1_CLK),
    .RAM3_P1_RD_DATA  (RAM3_P1_RD_DATA),
    .RAM3_P1_RD_EN    (RAM3_P1_RD_EN),
    .RAM3_RME_af      (RAM3_RME_af),
    .RAM3_RM_af       (RAM3_RM_af),
    .RAM3_TEST1_af    (RAM3_TEST1_af),
    .SCL_i            (SCL_i),
    .SCL_o            (SCL_o),
    .SCL_oen          (SCL_oen),
    .SDA_i            (SDA_i),
    .SDA_o            (SDA_o),
    .SDA_oen          (SDA_oen),
    .Valid_mult1      (Valid_mult1),
    .al_clr_i         (al_clr_i),
    .al_o             (al_o),
    .al_stick_en_i    (al_stick_en_i),
    .arst             (arst),
    .i2c_busy_o       (i2c_busy_o),
    .rxack_clr_i      (rxack_clr_i),
    .rxack_o          (rxack_o),
    .rxack_stick_en_i (rxack_stick_en_i),
    .tip_o            (tip_o),
    .wb_ack           (wb_ack),
    .wb_adr           (wb_adr),
    .wb_clk           (wb_clk),
