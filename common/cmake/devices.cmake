...
function(ADD_BITSTREAM_TARGET)
  ...
  # FPGA targets.
  #
  # If GEN_PARTIAL_BIT is set, the resulting configuration file will be
  # a partial bitstream.
  #
  ...
  #
  set(options USE_FASM GEN_PARTIAL_BIT)
  ...
  if(${USE_FASM})
    ...
    if(${ADD_BITSTREAM_TARGET_GEN_PARTIAL_BIT})
      set(FASM_TO_BIT_EXTRA_ARGS "${FASM_TO_BIT_EXTRA_ARGS} \-\-partial_bitstream")
    endif()
...
function(ADD_FPGA_TARGET)
  ...
  # * ${TOP}.${BITSTREAM_EXTENSION} - Bitstream for target.
  #
  set(options EXPLICIT_ADD_FILE_TARGET EMIT_CHECK_TESTS NO_SYNTHESIS ROUTE_ONLY GEN_PARTIAL_BIT)
  ...
  if(NOT ${NO_BITSTREAM})
    if(${USE_FASM})
      if(${ADD_FPGA_TARGET_GEN_PARTIAL_BIT})
        add_bitstream_target(
          NAME ${NAME}
          USE_FASM
          GEN_PARTIAL_BIT
